...
import com.team13.doctorclient.adapters.TimelineAdapter;
...
public class ScheduleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TimelineAdapter timelineAdapter= new TimelineAdapter(view.getContext(),getTimeline());
    ...
    ArrayList<Timeline> getTimeline(){
        ArrayList<Timeline> timelineArrayList= new ArrayList<Timeline>(10);
        for(String s: times){
            int a = isSeized(s);
            if(a!=-1){
                MyAppointment appointment = appointments.get(a);
                timelineArrayList.add(new Timeline(true,appointment.patientName,appointment.treatment,s));
            } else {
                timelineArrayList.add(new Timeline(false,null,null,null));
            }
        }
